 ...
 *      path {=string} - path to JS file (without "node_modules") - default = "dist"
 *      name {=string} - file name without ".min" & extention (if not equal to plugin name) - default = plugin name
 *      noMin {=boolean} - set TRUE if no need add ".min" to the file name
 ...
 *          Each Object in the "extend"  array must contains properties "path" & "name" (no default value)
 * @type {Object}
 */
var vendorsOptions = {
    select2: {
